...
from tester import get_train_test_data, get_preprocessor, cross_validate
...
if __name__ == '__main__':
    ...
    parser.add_argument('-est_name', type=str, default='xgb', help='Name of the estimator (e.g. xgb, lgb, cb)')
